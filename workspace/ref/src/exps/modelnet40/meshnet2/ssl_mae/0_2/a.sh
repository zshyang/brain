...
#SBATCH -p htcgpu1
#SBATCH -q normal
#SBATCH -o /scratch/zyang195/projects/base/err/slurm.000.out # file to save job's STDOUT (%j = JobId)
#SBATCH -e /scratch/zyang195/projects/base/err/slurm.000.err # file to save job's STDERR (%j = JobId)
