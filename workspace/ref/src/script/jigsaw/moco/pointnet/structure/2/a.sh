...
/workspace/script/jigsaw/moco/pointnet/structure/2/s.sh

cd $SRC_PATH
python3 cont.py --outf jigsaw/pointnet

if [[ $? -eq 124 ]]; then
  sbatch /scratch/zyang195/projects/base/src/script/jigsaw/moco/pointnet/structure/2/a.sh
fi
