...
from lib.models.meshnet import PointDescriptor, NormalDescriptor
from lib.models.meshnet import ConvSurface
from lib.models.meshnet import MaxPoolFaceFeature, MeshBlock
from lib.models.meshnet import PsuedoMeshBlock

class MeshNet2(nn.Module):
    """ MeshNet++ Model"""
    def __init__(self, cfg, num_faces, num_cls, pool_rate, **kwargs):
        """
        Args:
